  ...
  return (
    <div className="flex flex-col gap-20 ">
        <div className="flex flex-col items-center gap-4 ">
            <div className="flex items-center gap-2 text-[14px] text-green-600 bg-green-400/10 rounded-full px-6 py-1.5">
                      <svg
          ...
          <p className=" text-center text-slate-500">
            ...
            improve. If you<br></br> have a positive experience with us, leave a review.
          </p>
        </div>
        </div>
